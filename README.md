...
- **CSV Parsing**  
  Verifies that CSV files are correctly read and parsed into product objects.
- **Data Validation**  
  Ensures that product data (SKU, price, quantity, etc.) follows required formats and constraints.
- **Search Filters**  
  Tests the filtering logic for brand, color, and price range queries.
